    ...
    public static class MultiDayAggUDAFEvaluator extends GenericUDAFEvaluator {
        ...
        public void merge(AggregationBuffer agg, Object partial)
            ...
            for(Object strListObj : partialResultList) {
                ...
                this.sketchSetSize = Integer.parseInt( strInspector.getPrimitiveJavaObject( strList.get(2))	);
        ...
        public Object terminatePartial(AggregationBuffer agg) throws HiveException {
            ...
            for(int i=0; i<daysArr.length; ++i) {
                ...
                strList.add( Integer.toString( daysArr[i] )); //num_days
                strList.add( Long.toString(myagg.counts[i]) ); //cnt
                strList.add( Integer.toString(myagg.sketches[i].getMaxItems() ) ); //sketch_set_size
